		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zfiauthomatrix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiauthomatrix-display": {
								"semanticObject": "zfiauthomatrix",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiauthomatrix",
									"url": sap.ui.require.toUrl("zfiauthomatrix")
								}
							}
						}
					}
